...
rem exes and is layout-sensitive. seed -randlayout=1 is Microsoft=undetected
rem for the 1.0.7 sources (VT sha256 5788f9e9..., malicious=5 minor generic-ML
...
rem (History: 1.0.4=4400, 1.0.5=101, 1.0.6=4400, 1.0.7=31676 then 1 after the
rem  cert-dialog restyle.)
...
go build -trimpath -buildvcs=false -ldflags "-H windowsgui -randlayout=1" -o "%ROOT%builds\rdpkey.exe" .
