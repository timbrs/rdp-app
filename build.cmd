...
rem exes and is layout-sensitive. seed -randlayout=31676 is Microsoft=undetected
rem for the 1.0.9 sources (VT sha256 43d9f7e2..., malicious=4 minor generic-ML
...
go build -trimpath -buildvcs=false -ldflags "-H windowsgui -randlayout=31676" -o "%ROOT%builds\rdpkey.exe" .
