...
rem exes and is layout-sensitive. seed -randlayout=99 is clean for the 1.0.10
rem sources on BOTH the local Defender cloud (MpCmdRun, live) AND VT Microsoft
rem (VT sha256 67136323..., malicious=11: OEM/Bkav/DeepInstinct cluster, no major
...
go build -trimpath -buildvcs=false -ldflags "-H windowsgui -randlayout=99" -o "%ROOT%builds\rdpkey.exe" .
